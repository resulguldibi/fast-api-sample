...
host_server = os.environ.get('host_server', 'postgres')
db_server_port = urllib.parse.quote_plus(str(os.environ.get('db_server_port', '5432')))
database_name = os.environ.get('database_name', 'fastapi')
db_username = urllib.parse.quote_plus(str(os.environ.get('db_username', 'postgresuser')))
db_password = urllib.parse.quote_plus(str(os.environ.get('db_password', 'pwd123')))
